...
plt.xlabel(' Home Expected Goal Difference')
plt.ylabel(' Away Expected Goal Difference')
plt.title('Comparison of Home Expected Goal Difference vs Away Expected Goal Difference')
...
plt.text(0.88, 0.05, 'Good atHome', fontsize=10, color='black', ha='left', va='bottom', transform=plt.gca().transAxes)
...
plt.text(0.01, 0.05, 'Bad atHome', fontsize=10, color='black', ha='left', va='bottom', transform=plt.gca().transAxes)
...
plt.text(0.01, 0.53, 'Bad atHome', fontsize=10, color='black', ha='left', va='bottom', transform=plt.gca().transAxes)
plt.text(0.01, 0.50, 'Good Away', fontsize=10, color='black', ha='left', va='bottom', transform=plt.gca().transAxes)
plt.text(0.88, 0.53, 'Good atHome', fontsize=10, color='black', ha='left', va='bottom', transform=plt.gca().transAxes)
