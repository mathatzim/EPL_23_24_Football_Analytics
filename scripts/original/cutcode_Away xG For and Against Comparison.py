...
ax.spines['top'].set_position(('outward', Y_avg * -4.3))  
ax.spines['right'].set_position(('outward', X_avg * -14.4))

plt.xlabel(' Away Expected Goals For')
plt.ylabel(' Away Expected Goals Against')
plt.title('Comparison of Away Expected Goals For vs Away Expected Goals Against')
