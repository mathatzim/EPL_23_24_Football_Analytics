...
plt.text(0.01, 1.00, 'Avg Home Wins: 8.75', fontsize=11, color='black', ha='left', va='bottom', transform=plt.gca().transAxes)
plt.text(0.15, 1.00, 'Avg Home Draws: 4.10', fontsize=11, color='black', ha='left', va='bottom', transform=plt.gca().transAxes)
plt.text(0.85, 1.00, 'Avg Home Loses: 6.15', fontsize=11, color='black', ha='left', va='bottom', transform=plt.gca().transAxes)
...
ax_pie.set_title('Distribution of Home Results')
