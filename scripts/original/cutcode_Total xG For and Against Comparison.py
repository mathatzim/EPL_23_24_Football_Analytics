...
ax.spines['top'].set_position(('outward',  Y_avg * -2.2))  
ax.spines['right'].set_position(('outward', X_avg * -6.5))


plt.xlabel(' Total Expected Goals For')
plt.ylabel(' Total Expected Goals Against')
plt.title('Comparison of Expected Goals For vs Expected Goals Against')
...
plt.text(0.44, 0.02, f"Avg xG For: {X_avg:.2f}", fontsize=10, color='black', ha='left', va='bottom', transform=plt.gca().transAxes)
...
plt.text(0.01, 0.58, f"Avg xG Against: {Y_avg:.2f}", fontsize=10, color='black', ha='left', va='top', transform=plt.gca().transAxes)
plt.text(0.02, 0.65, 'Bad Offense', fontsize=10, color='black', ha='left', va='bottom', transform=plt.gca().transAxes)
plt.text(0.02, 0.62, 'Bad Defense', fontsize=10, color='black', ha='left', va='bottom', transform=plt.gca().transAxes)
plt.text(0.88, 0.65, 'Good Offense', fontsize=10, color='black', ha='left', va='bottom', transform=plt.gca().transAxes)
plt.text(0.88, 0.62, 'Bad Defense', fontsize=10, color='black', ha='left', va='bottom', transform=plt.gca().transAxes)
